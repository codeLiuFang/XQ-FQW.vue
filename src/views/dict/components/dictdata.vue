<template>
  <div>
    ...
    <el-dialog :title='dictDataTitle' :visible.sync="dictinfovisible" @close="dialogclose">
      <div>
        <el-form ref="dictform" :model="dictform" label-width="80px" label-position="left">
          <el-form-item label="字典标签" prop="label" required>
            <el-input v-model="dictform.label" required></el-input>
          </el-form-item>
          <el-form-item label="字典键值" prop="value" required>
            <el-input v-model="dictform.value" required></el-input>
          </el-form-item>
