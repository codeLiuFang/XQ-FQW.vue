var GV = (function() {
	...
	var finshnetUrl = "http://172.16.1.19:6080/arcgis/rest/services/fishnet/fishnet/MapServer/0";
	...
	require(
			...
			function(GraphicsLayer, Polyline, lang, parser, on, Map, Extent,
				...
				function init() {
					...
					var extent = {
		            		"xmin": 98.05659624111831,
					        "ymin": 11.010239309119644,
					        "xmax": 167.80335724401553,
					        "ymax": 49.081615402404125,
