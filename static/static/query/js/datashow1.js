...
$(document).ready(function ($) {
    ...
    function loadJqGrid(queryData) {
        ...
        if (isShowBc() == '') {
            var thead = "<thead><tr><th style='text-align: center;width:16.6%'>学科</th><th style='text-align: center;width:16.6%'>要素</th><th style='text-align: center;width:16.6%'>类型</th><th style='text-align: center;width:16.6%'>数据量</th><th style='text-align: center;width:16.6%'>国内/国际</th><th style='text-align: center;width:16.6%'>详情</th></tr></thead>";
            $("#example").html(thead);
            dttable = $('#example').DataTable({
                 ...
                 "autoWidth": false,
                 "columnDefs":[{"width":"110px",targets:'_all'}],
                "ajax": {
                    "url": listUrl,
                    "type": "POST",
                    "dataType": "json",
                ...
                "columns": [
                    ...
                    {"data": "nationType"},
                    {
                        ...
                        var datatmp = "srcTable=" + row.srcTable + "&factorCode=" + row.factorCode+"&dataType="+row.tableType;
            ...
            var thead = "<thead><tr><th style='text-align: center;width:12.5%'>学科</th><th style='text-align: center;width:12.5%'>要素</th><th style='text-align: center;width:12.5%'>类型</th><th style='text-align: center;width:12.5%'>来源大类</th><th style='text-align: center;width:12.5%'>来源子类</th><th style='text-align: center;width:12.5%'>数据量</th><th style='text-align: center;width:12.5%'>国内/国际</th><th style='text-align: center;width:12.5%'>详情</th></tr></thead>";
            $("#example").html(thead);
            dttable = $('#example').DataTable({
            	 "processing": true,
                 "serverSide": true,
